  ...
  return (
    ...
    <div className="min-h-screen w-full bg-slate-950 flex flex-col relative">
      <Link
        ...
        className="absolute top-6 left-6 p-2 flex items-center gap-2 text-zinc-500 hover:text-cyan-400 hover:bg-white/5 rounded-full transition-all duration-300 group"
