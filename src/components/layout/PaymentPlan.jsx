    ...
    <div className="relative font-sans flex items-center justify-center selection:bg-cyan-500/30 ">
      ...
      >
        ...
        <div className="pt-6 flex justify-between items-center">
          ...
          <button
            ...
            className="group flex items-center gap-4 px-8 py-4 rounded-full bg-linear-to-r from-violet-600 to-cyan-500 text-white font-bold text-lg shadow-[0_10px_30px_-10px_rgba(6,182,212,0.5)] hover:scale-105 active:scale-95 transition-all"
          >
            Pagar Agora
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4 bg-zinc-950/90 backdrop-blur-md animate-in fade-in duration-300">
          <div className="w-full max-w-sm bg-zinc-900 border border-white/10 rounded-[2.5rem] p-8 relative flex flex-col items-center shadow-2xl animate-in zoom-in-95 slide-in-from-bottom-8">
            {/* Botão Fechar */}
            <button
              ...
              <div className="w-full space-y-8 text-center animate-in fade-in slide-in-from-top-4">
                ...
                <div className="grid grid-cols-1 gap-4">
                  <button
                    ...
                    className="flex items-center gap-5 p-4 rounded-3xl border border-white/5 bg-zinc-950/40 hover:border-cyan-500 group transition-all duration-300"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center gap-5 p-4 rounded-3xl border border-white/5 bg-zinc-950/40 hover:border-violet-500 group transition-all duration-300"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center gap-5 p-4 rounded-3xl border border-white/5 bg-zinc-950/40 hover:border-zinc-400 group transition-all duration-300"
                  >
                    <div className="p-3 rounded-2xl bg-zinc-500/10 text-zinc-400 group-hover:scale-110 transition-transform">
                      <Barcode size={24} />
                    </div>
                    <div className="text-left">
                      <p className="text-base font-bold text-white leading-none mb-1">
            ...
            {paymentStep === "pix" && (
              <div className="w-full flex flex-col items-center animate-in fade-in zoom-in-95">
                <div className="mb-6 p-4 rounded-full bg-cyan-500/10 text-cyan-400 border border-cyan-500/20 shadow-[0_0_20px_-5px_rgba(6,182,212,0.4)]">
                  <QrCode size={40} />
                </div>
                ...
                <div className="w-60 h-60 bg-white p-3 rounded-4xl mb-6 shadow-2xl border-4 border-white/10">
                ...
                <div className="w-full relative mb-8">
                  <input
                    ...
                    readOnly
                    className="w-full bg-zinc-950 border border-white/10 rounded-2xl py-4 pl-5 pr-14 text-xs text-zinc-500 font-mono focus:outline-none"
                  />
                ...
                <button className="w-full py-4 rounded-2xl bg-linear-to-r from-violet-600 to-cyan-500 text-white font-bold text-lg hover:brightness-110 active:scale-95 transition-all flex items-center justify-center gap-3">
            ...
            {paymentStep === "card" && (
              <div className="w-full animate-in fade-in slide-in-from-right-8">
                ...
                <div className="space-y-6 mb-10">
                  <div className="group">
                    <input
                      ...
                      className="w-full bg-transparent border-b border-white/10 py-3 text-base text-white focus:outline-none focus:border-cyan-500 transition-all font-mono tracking-widest"
                    />
                  </div>
                  <input
                    type="text"
                    placeholder="Nome no Cartão"
                    className="w-full bg-transparent border-b border-white/10 py-3 text-base text-white focus:outline-none focus:border-cyan-500 uppercase"
                  />
                  <div className="grid grid-cols-2 gap-8">
                    <input
                      type="text"
                      placeholder="MM/AA"
                      className="bg-transparent border-b border-white/10 py-3 text-base text-white text-center focus:outline-none focus:border-cyan-500 transition-all"
                    />
                    <input
                      type="text"
                      placeholder="CVV"
                  ...
                  <div className="relative">
                    <select className="w-full bg-transparent border-b border-white/10 py-3 text-base text-zinc-400 focus:outline-none focus:border-cyan-500 cursor-pointer appearance-none">
                      <option className="bg-zinc-900">1x R$ 199,90</option>
                      <option className="bg-zinc-900" selected>
                        4x R$ 49,97 (Sem juros)
                      </option>
                      <option className="bg-zinc-900">12x R$ 21,50</option>
                    </select>
                    <ChevronRight
                ...
                <button className="w-full py-4 rounded-2xl bg-linear-to-r from-violet-600 to-cyan-500 text-white font-bold text-lg active:scale-95 transition-all flex items-center justify-center gap-3">
                ...
                <div className="w-full space-y-4 mb-8">
                  <div className="relative">
                    <input
                      ...
                      readOnly
                      className="w-full bg-zinc-950 border border-white/10 rounded-2xl py-4 pl-4 pr-12 text-[10px] text-zinc-400 font-mono shadow-inner"
                    />
                    <button className="absolute right-3 top-1/2 -translate-y-1/2 text-white p-2 hover:bg-white/10 rounded-lg">
                      <Copy size={18} />
                    </button>
                  </div>
                  <button className="w-full py-4 rounded-2xl border border-white/10 text-zinc-300 font-bold text-sm hover:bg-white/5 transition-all flex items-center justify-center gap-3">
                    BAIXAR PDF <Download size={20} />
                  </button>
                </div>

                <button className="w-full py-4 rounded-2xl bg-linear-to-r from-violet-600 to-cyan-500 text-white font-bold text-lg active:scale-95 transition-all">
                  JÁ PAGUEI
                </button>
              </div>
            )}
            ...
            {paymentStep !== "select" && (
              <button
                ...
                className="mt-8 text-[11px] font-bold text-zinc-600 hover:text-cyan-500 uppercase tracking-[0.2em] flex items-center gap-2 transition-all"
              >
